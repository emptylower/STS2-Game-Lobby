...
test("release sources pin client alpha.3 and service alpha.1 while preserving older fixtures", () => {
  ...
  assert.equal(clientManifest.version, "0.6.0-alpha.3");
  assert.match(clientProject, /<Version>0\.6\.0-alpha\.3<\/Version>/);
