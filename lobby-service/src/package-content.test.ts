...
test("release sources pin service v0.5.6-rc1 and client v0.5.6-rc3 while preserving older fixtures", () => {
  ...
  assert.equal(clientManifest.version, "0.5.6-rc3");
  assert.match(clientProject, /<Version>0\.5\.6-rc3<\/Version>/);
