...
test("release sources pin client alpha.2 and service alpha.1 while preserving older fixtures", () => {
  ...
  assert.equal(clientManifest.version, "0.6.0-alpha.2");
  assert.match(clientProject, /<Version>0\.6\.0-alpha\.2<\/Version>/);
