...
test("release sources pin client and service alpha.6 while preserving older fixtures", () => {
  ...
  assert.equal(clientManifest.version, "0.6.0-alpha.6");
  assert.match(clientProject, /<Version>0\.6\.0-alpha\.6<\/Version>/);
