...
当前公开预览通过 GitHub Pre-release [`v0.5.2-rc.1`](https://github.com/emptylower/STS2-Game-Lobby/releases/tag/v0.5.2-rc.1) 提供；稳定版仍为 `v0.5.1`，本次不更新 [Steam 创意工坊](https://steamcommunity.com/sharedfiles/filedetails/?id=3749766330)。v0.5.2 只更新客户端，继续使用 lobby-service 0.5.1 和 v0.5.1 聊天协议；同一客户端包以游戏 `0.107.1` 与 `0.109.0` 为加载目标。
