...
当前候选完成玩家确认后将发布到 GitHub v0.5.2 Release；Steam 玩家也可订阅 [游戏大厅](https://steamcommunity.com/sharedfiles/filedetails/?id=3749766330)。v0.5.2 只更新客户端，继续使用 lobby-service 0.5.1 和 v0.5.1 聊天协议；同一客户端包以游戏 `0.107.1` 与 `0.109.0` 为加载目标。
