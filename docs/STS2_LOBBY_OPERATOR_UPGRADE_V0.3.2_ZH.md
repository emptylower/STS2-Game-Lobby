...
> ⚠️ **本文档对应 v0.3.2，不是当前推荐版本**。  
> v0.4.0 进一步移除了所有 `SERVER_REGISTRY_*` 上报路径，环境变量与流程都有变动。新部署或升级到 v0.4.0 请改看 [`./STS2_LOBBY_DEPLOYMENT_GUIDE_ZH.md`](./STS2_LOBBY_DEPLOYMENT_GUIDE_ZH.md)。  
> 本文保留作为 v0.3.x 历史迁移参考。
