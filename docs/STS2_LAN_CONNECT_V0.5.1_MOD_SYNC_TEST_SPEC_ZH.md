...
| 版本 | 来源 | Phase 0 证据 |
|---|---|---|
| 0.107.1 | Steam `public`，build `23811903` | 当前 `release_info.json` 为 `v0.107.1` |
| 0.108.0 | Steam `public-beta`，build `24032229` | 官方分支与补丁说明可用；Phase 8 下载后固化哈希 |
| 0.109.0 | Steam 私有 `playtesters` 分支 | 本机 2026-07-17 四份日志记录 `release=v0.109.0`；Phase 8 切换后固化哈希 |
