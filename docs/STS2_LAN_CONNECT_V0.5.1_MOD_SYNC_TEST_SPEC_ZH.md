...
> 正式发布记录：自动化门禁、测试服务、v0.107.1 与 v0.109.0 实机证据均已保留。0.108.0 最终候选实机重跑、第二台 Steam 客户端和 Android 实机仍未补齐；2026-07-18 发布负责人明确接受这些剩余风险并授权正式发布。本文未勾选的历史验收项继续保持未完成，不以授权替代测试证据。
