...
internal sealed class LanConnectChatLocalizer
{
    private static readonly IReadOnlyDictionary<string, string> English = ReadOnly(
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["chat.verb.shared.card"] = "shared a card: ",
            ["chat.verb.shared.relic"] = "shared a relic: ",
            ["chat.verb.shared.potion"] = "shared a potion: ",
            ["chat.verb.shared.item"] = "shared an item: ",
            ...
            ["chat.input.placeholder.hud"] = "Enter to send, Esc to cancel...",
            ...
            ["chat.fade.reopen_hint"] = "Press Enter to chat",
            ...
            ["chat.delivery.not_delivered"] = "Not delivered",
            ["chat.review.pending"] = "Under review",
            ["chat.review.blocked_title"] = "Message blocked",
            ["chat.review.blocked"] = "This message contains prohibited content. Please try again later.",
            ["chat.review.busy"] = "Your previous message is still under review. Please wait before sending another.",
    ...
    private static readonly IReadOnlyDictionary<string, string> SimplifiedChinese = ReadOnly(
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["chat.verb.shared.card"] = "分享了卡牌：",
            ["chat.verb.shared.relic"] = "分享了遗物：",
            ["chat.verb.shared.potion"] = "分享了药水：",
            ["chat.verb.shared.item"] = "分享了物品：",
            ...
            ["chat.input.placeholder.hud"] = "回车发送，Esc 取消…",
            ...
            ["chat.fade.reopen_hint"] = "按 Enter 打开聊天",
            ...
            ["chat.delivery.not_delivered"] = "未送达",
            ["chat.review.pending"] = "在审核中",
            ["chat.review.blocked_title"] = "消息被拦截",
            ["chat.review.blocked"] = "包含违禁词，请稍后再试",
            ["chat.review.busy"] = "上一条消息仍在审核中，请稍后再发",
