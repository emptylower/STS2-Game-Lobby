...
internal static class LanConnectCapabilitiesCodec
{
        ...
        ushort sessionProtocolVersion)
    {
        ...
        if (present != sidecar)
        {
            throw Invalid("RitsuLib peer offers must declare presence and public typed-sidecar readiness together.");
        }
    ...
    {
        1 => LanConnectProtocolCarrier.StandaloneTailV1,
        2 => LanConnectProtocolCarrier.RitsuLibSidecarV1,
