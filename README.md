...
**STS2 LAN Connect** 是《Slay the Spire 2》的第三方联机大厅方案。当前正式客户端为 **v0.5.2**，大厅服务继续使用 **v0.5.1**，主要服务对象是：
...
**STS2 LAN Connect** is a third-party multiplayer lobby stack for *Slay the Spire 2*. The current stable client is **v0.5.2**, while the lobby service remains at **v0.5.1**.
