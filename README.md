...
![Client](https://img.shields.io/badge/client-v0.5.2--rc.1-orange)
...
**STS2 LAN Connect** 是《Slay the Spire 2》的第三方联机大厅方案。当前分支发布客户端 **v0.5.2-rc.1 公开预览**，大厅服务继续使用 **v0.5.1**，主要服务对象是：
...
- 客户端 MOD：`0.5.2`（预览标签 [`v0.5.2-rc.1`](https://github.com/emptylower/STS2-Game-Lobby/releases/tag/v0.5.2-rc.1)）
- 大厅服务：`0.5.1`
- GitHub 稳定版：仍为 [`v0.5.1`](https://github.com/emptylower/STS2-Game-Lobby/releases/tag/v0.5.1)；`v0.5.2-rc.1` 仅为 Pre-release，不代表已合并 main
...
| [`docs/RELEASE_NOTES_V0.5.2_ZH.md`](./docs/RELEASE_NOTES_V0.5.2_ZH.md) | v0.5.2-rc.1 客户端预览说明、引用操作、兼容范围与回滚步骤 |
...
**STS2 LAN Connect** is a third-party multiplayer lobby stack for *Slay the Spire 2*. This branch publishes the **v0.5.2-rc.1 client preview** while the lobby service remains at **v0.5.1**.
...
### v0.5.2-rc.1 client preview highlights
...
- Client MOD: `0.5.2` (preview tag [`v0.5.2-rc.1`](https://github.com/emptylower/STS2-Game-Lobby/releases/tag/v0.5.2-rc.1))
- Lobby Service: `0.5.1`
- Stable GitHub release: still [`v0.5.1`](https://github.com/emptylower/STS2-Game-Lobby/releases/tag/v0.5.1); `v0.5.2-rc.1` is a Pre-release and is not merged into main
