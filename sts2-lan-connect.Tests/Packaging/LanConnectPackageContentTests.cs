...
public sealed class LanConnectPackageContentTests
{
    ...
    public async Task Client_package_uses_exact_allowlist_source_legal_bytes_and_deterministic_output()
    {
        ...
        Assert.Equal("0.6.0-alpha.5", manifest.RootElement.GetProperty("version").GetString());
        ...
        Assert.StartsWith("0.6.0-alpha.5", assemblyVersion.ProductVersion, StringComparison.Ordinal);
    ...
    public void Client_v053_release_documents_the_continue_channel_split_without_requiring_a_service_upgrade()
    {
        ...
        Assert.Contains("0.6.0-alpha.5", workshop, StringComparison.Ordinal);
        Assert.Contains("当前版本：0.6.0-alpha.5", workshop, StringComparison.Ordinal);
    ...
    public void Client_v060_alpha1_documents_dual_protocol_and_public_Ritsu_boundary()
    {
        ...
        Assert.Contains("0.6.0-alpha.5", clientReadme, StringComparison.Ordinal);
